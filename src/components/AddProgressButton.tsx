...
function AddProgressButton(props: { trackerId: string; userId: string }) {
  ...
  const [state, addProgressToTrackerAction] = useFormState(
    addProgressToTracker,
    initialState
  );
        ...
        <Form action={addProgressToTrackerAction}>
          ...
          <Modal.Body>
            ...
            <input
              style={{ display: "none" }}
              type="hidden"
              id="progress-trackerId"
              name="progress-trackerId"
            ...
            <InputGroup className="mb-3">
              <Form.Control id="progress-summary" name="progress-summary" />
            </InputGroup>
          </Modal.Body>
          <Modal.Footer>
